...
import com.kumasi.journal.mock.CategoryEntityMock;
...
/**
 * JUnit test case for Category persistence service
 * 
...
public class CategoryPersistenceTest 
{
	...
	public void test1() {
		...
		CategoryPersistence service = PersistenceServiceProvider.getService(CategoryPersistence.class);
	...
	public void test2() {
		...
		System.out.println("Test Category persistence : delete + load ..." );
		
		CategoryPersistence service = PersistenceServiceProvider.getService(CategoryPersistence.class);
		
		CategoryEntityMock mock = new CategoryEntityMock();
	...
	private void process(CategoryPersistence service, CategoryEntityMock mock, Integer id ) {
		System.out.println("----- "  );
		System.out.println(" . load : " );
		CategoryEntity entity = service.load( id );
		if ( entity != null ) {
			// Found 
