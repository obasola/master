...
/**
 * JPA implementation for basic persistence operations ( entity "Category" )
 * 
 * @author Telosys Tools Generator
 *
 */
public class CategoryPersistenceJPA extends GenericJpaService<CategoryEntity, Integer> implements CategoryPersistence {
	...
	public long countAll() {
		...
		JpaOperation operation = new JpaOperation() {
			...
			public Object exectue(EntityManager em) throws PersistenceException {
				Query query = em.createNamedQuery("CategoryEntity.countAll");
